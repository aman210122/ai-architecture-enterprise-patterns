...
**Deterministic state transitions for regulated workflows.**
## Live Demo
**[Launch](https://aman210122.github.io/ai-architecture-enterprise-patterns/patterns/03-multi-agent-safety-gates/state-machine-agent/index.html)**
