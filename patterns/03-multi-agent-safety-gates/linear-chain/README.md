# Variant: Linear Chain
**Sequential agents with safety checkpoints between each stage.**
## Live Demo
**[Launch](https://aman210122.github.io/ai-architecture-enterprise-patterns/patterns/03-multi-agent-safety-gates/linear-chain/index.html)**
